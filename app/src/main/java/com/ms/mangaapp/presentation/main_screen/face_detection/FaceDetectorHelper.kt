...
class FaceDetectorHelper(
    ...
    fun detectLivestreamFrame(imageProxy: ImageProxy) {
        ...
        // Added by MS as while navigating between the screens it crashes because it cant initialize
        if (faceDetector == null) {
            imageProxy.close() // Don't forget to release the frame
            Log.w(TAG, "detectLivestreamFrame: FaceDetector is not yet initialized.")
            return
        }
        // \\Added by me.
    ...
    fun detectAsync(mpImage: MPImage, frameTime: Long) {
        ...
        faceDetector?.detectAsync(mpImage, frameTime) // main line but causing error line
    }
